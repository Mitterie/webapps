...
public class Main extends HttpServlet
{
    ...
    throws ServletException, IOException
    {
        ...
        if(session.getAttribute("token") != null){
            ...
            out.println("<body><div class=\"videos\"><h2>Vidéos des mites</h2><form action=\"Main\" method=\"post\"><input type=\"checkbox\" name=\"jeune\" value=\"vrai\"/><label for=\"jeune\">Ordre croissant</label><button type=\"submit\">Recharger</button></form>");
